#!/usr/bin/perl -I/home/cechoi/Desktop/Dorabella Cipher/dorabella-experiments/TextDeciphermentPrograms/hhk-decipherment/Solver
...
my ($wordlm1_file, $wordlm2_file, $wordlm3_file) 
  = ('../LM/LM/unigramWord.txt','../LM/LM/bigramWord.txt','../LM/LM/trigramWord.txt');
my ($charlm1_file, $charlm2_file, $charlm3_file) 
  = ('../LM/LM/unigramChar.txt','../LM/LM/bigramChar.txt','../LM/LM/trigramChar.txt');
my ($wl1, $wl2, $wl3)
...
my $x = 0.05;
my $ngramlist = '../LM/LM/patternList.txt';
